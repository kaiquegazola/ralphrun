...
const en = {
  ...
  "cli.create.desc": "Register this folder as a ralphrun project (it shows up in the desktop app).",
  "cli.create.optName": "display name for the project (default: folder name)",
  "cli.create.done": "✓ project '{name}' registered — {dir}",
  "cli.create.already": "project '{name}' was already registered — {dir}",
  "cli.create.noDir": "❌ {dir} does not exist",
  ...
  "prd.err.id": "task[{i}].id must be a non-empty string",
...
const ptBr: Record<MsgKey, string> = {
  ...
  "cli.create.desc": "Registra esta pasta como um projeto do ralphrun (ela aparece no app desktop).",
  "cli.create.optName": "nome de exibição do projeto (padrão: nome da pasta)",
  "cli.create.done": "✓ projeto '{name}' registrado — {dir}",
  "cli.create.already": "projeto '{name}' já estava registrado — {dir}",
  "cli.create.noDir": "❌ {dir} não existe",
  ...
  "prd.err.id": "task[{i}].id precisa ser uma string não vazia",
