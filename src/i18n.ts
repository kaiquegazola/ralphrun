...
const en = {
  ...
  "loop.reason.mergeDirty": "merge-back refused by your uncommitted changes",
  ...
  "loop.reason.policyNeedsVerify": "review_blocked_policy=accept, but verify did not pass",
...
const ptBr: Record<MsgKey, string> = {
  ...
  "loop.reason.mergeDirty": "merge de volta recusado pelas suas mudanças não commitadas",
  ...
  "loop.reason.policyBlock": "review_blocked_policy=block",
  "loop.reason.policyNeedsVerify": "review_blocked_policy=accept, mas o verify não passou",
  "run.log.native": "  {id}: NATIVE {cli} {model} + advisor {advisorModel}",
  "run.log.cross": "  {id}: CROSS executor {executor}",
