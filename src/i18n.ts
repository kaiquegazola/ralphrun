...
const en = {
  ...
  "loop.log.prdCommitted": "  {id}: PRD committed — {hash}",
  "loop.log.prdCommitRefused": "  {id}: git refused the PRD status commit — task blocked",
  ...
  "loop.log.parallelSerial": "  {id}: running serially — {reason}",
  "loop.log.learned": "  {id}: learned, added to architecture_notes — {note}",
  ...
  "loop.log.worktreePreserved": "  {id}: failed work preserved at {ref} ({hash})",
  ...
  "loop.reason.prdCommitRefused": "git refused the PRD status commit",
  ...
  "run.log.verifyChanged": "  {id}: reviewer repaired the verify command — rerunning: {cmd}",
  "run.log.reviewRetrying": "  {id}: round {n} → reviewer gave no actionable verdict; retrying review",
  ...
  "exec.quit": "  {tag}: interrupted by quit — stopping {cli}",
  ...
  "expand.log.start": "  {id}: skeleton task — asking the advisor to expand it just in time",
  "expand.log.failed": "  {id}: expansion produced no usable spec — running with what the PRD has",
  "expand.log.done": "  {id}: expanded (description, acceptance, scope, verify filled)",
  "expand.log.partial": "  {id}: partially expanded — description/acceptance still missing (verify is present, so the gate is real)",
  "expand.reason.noVerify": "skeleton task with no verify command and no advisor to write one — it could never be verified",
  "expand.reason.browserMissing": "the expanded verify uses dev-browser, which is not installed (install: {cmd})",
  "expand.reason.browserBroken": "the expanded verify uses dev-browser, which is installed but will not run (reinstall: {cmd})",
  "exec.blocked": "  {tag}: executor reported BLOCKED — {reason}",
  "exec.spawnFailed": "  {tag}: failed to spawn {cli} — {msg}",
  "exec.rawTruncated": "  {tag}: raw executor output truncated after the log limit ({n} lines / {chars} chars omitted)",
  ...
  "prd.err.sharedScope": "task[{i}].shared_scope must be an array",
  "prd.err.sharedScopeItem": "task[{i}].shared_scope items must be strings",
  "prd.err.forbiddenScope": "task[{i}].forbidden_scope must be an array",
  "prd.err.forbiddenScopeItem": "task[{i}].forbidden_scope items must be strings",
  "prd.err.scopeRequests": "task[{i}].scope_requests must be an array of { paths: string[], reason: string }",
...
const ptBr: Record<MsgKey, string> = {
  ...
  "loop.log.prdCommitted": "  {id}: PRD commitado — {hash}",
  "loop.log.prdCommitRefused": "  {id}: o git recusou o commit do status do PRD — task bloqueada",
  ...
  "loop.log.parallelSerial": "  {id}: executando em série — {reason}",
  "loop.log.learned": "  {id}: aprendizado registrado em architecture_notes — {note}",
  ...
  "loop.log.worktreePreserved": "  {id}: trabalho da tentativa preservado em {ref} ({hash})",
  ...
  "loop.reason.prdCommitRefused": "o git recusou o commit do status do PRD",
  ...
  "run.log.verifyChanged": "  {id}: reviewer corrigiu o comando verify — executando novamente: {cmd}",
  "run.log.reviewRetrying": "  {id}: rodada {n} → reviewer não deu um veredito acionável; tentando o review de novo",
  ...
  "exec.quit": "  {tag}: interrompida ao sair — parando {cli}",
  ...
  "expand.log.start": "  {id}: task esqueleto — pedindo ao advisor para expandi-la agora",
  "expand.log.failed": "  {id}: expansão não produziu spec utilizável — rodando com o que o PRD tem",
  "expand.log.done": "  {id}: expandida (description, acceptance, scope, verify preenchidos)",
  "expand.log.partial": "  {id}: parcialmente expandida — description/acceptance ainda faltam (verify presente, o portão é real)",
  "expand.reason.noVerify": "task esqueleto sem verify e sem advisor para escrever um — nunca poderia ser verificada",
  "expand.reason.browserMissing": "o verify expandido usa dev-browser, que não está instalado (instale: {cmd})",
  "expand.reason.browserBroken": "o verify expandido usa dev-browser, que está instalado mas não executa (reinstale: {cmd})",
  "exec.blocked": "  {tag}: executor reportou BLOQUEIO — {reason}",
  "exec.spawnFailed": "  {tag}: falha ao iniciar {cli} — {msg}",
  "exec.rawTruncated": "  {tag}: saída bruta do executor truncada pelo limite do log ({n} linhas / {chars} caracteres omitidos)",
  ...
  "advisor.reviewAlreadySatisfied": "  {id}: executor relata que a task já está satisfeita — reviewer validando o workspace atual",
  ...
  "prd.err.sharedScope": "task[{i}].shared_scope precisa ser um array",
  "prd.err.sharedScopeItem": "task[{i}].shared_scope precisa conter apenas strings",
  "prd.err.forbiddenScope": "task[{i}].forbidden_scope precisa ser um array",
  "prd.err.forbiddenScopeItem": "task[{i}].forbidden_scope precisa conter apenas strings",
  "prd.err.scopeRequests": "task[{i}].scope_requests precisa ser uma lista de { paths: string[], reason: string }",
