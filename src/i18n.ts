...
const en = {
  ...
  "run.log.resuming": "  {id}: round {n} → resuming the executor's session (sending only the feedback)",
...
const ptBr: Record<MsgKey, string> = {
  ...
  "run.log.resuming": "  {id}: rodada {n} → retomando a sessão do executor (mandando só o feedback)",
